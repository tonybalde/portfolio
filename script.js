(() => {
  ...
  const dict = {
    es: {
      ...
      "about.p1": "Soy Tony Baldessari, desarrollador frontend y WordPress autodidacta. Programo desde 2023 con pasión y dedicación, construyendo sitios web y aplicaciones tanto con WordPress como con código.",
      "about.p2": "Con WordPress mi stack habitual es WordPress + Elementor, Figma, Divi y código PHP o JavaScript para sumar funcionalidades extra a los sitios. En frontend uso React, Tailwind, Git, GitHub, Supabase, MongoDB, VSCode, Codex, Claude y demás herramientas según lo que pida cada proyecto.",
    ...
    en: {
      ...
      "about.p1": "I'm Tony Baldessari, a self-taught frontend and WordPress developer. I've been coding since 2023 with passion and dedication, building websites and applications with both WordPress and custom code.",
      "about.p2": "With WordPress, my usual stack is WordPress + Elementor, Figma, Divi, and PHP or JavaScript for extra site functionality. On the frontend I use React, Tailwind, Git, GitHub, Supabase, MongoDB, VSCode, Codex, Claude, and whatever other tools each project calls for.",      "projects.eyebrow": "Work",
