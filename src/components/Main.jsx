      ...
      <img className="w-full h-screen object-cover object-left scale-x-[-1] " src="https://images.unsplash.com/photo-1587620962725-abab7fe55159?q=80&w=1631&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        <div className="w-full h-screen absolute top-0 left-0 bg-white/50">
            <div className="max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center">
                ...
                <h1 className="sm:text-5xl text-4xl font-bold text-black text-center ">Hi!, I'm Tony Baldessari</h1>
                ...
                <div className="flex justify-around gap-2 pt-6 max-w-[400px] w-full align-center"> {/* Here are the Social */}
                ...
                <div className="border-0 rounded-xl items-center bg-black text-white font-bold pl-2 pr-2 pt-1 pb-1 mt-8">
                  <a href="http://www.google.com.ar" target="_blank" className="flex gap-2"><FaFileDownload  className="cursor-pointer hover:scale-110 transition ease-in" size={20}/>Download Resumé</a>
                </div>
            </div>
        </div>
    </div>
