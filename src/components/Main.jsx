        ...
        <div className="w-full h-screen absolute top-0 left-0 bg-white/50">
            <div className="max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center">
                ...
                <div className="border-0 rounded-xl items-center bg-black text-white font-bold pl-2 pr-2 pt-1 pb-1 mt-8">
                  <a href="https://drive.google.com/file/d/1MQU_rUYcIW2x6-Ea4q932-qs-r0QhRzH/view?usp=share_link" target="_blank" className="flex gap-2"><FaFileDownload  className="cursor-pointer hover:scale-110 transition ease-in" size={20}/>Download Resumé</a>
                </div>
            </div>
        </div>
    </div>
